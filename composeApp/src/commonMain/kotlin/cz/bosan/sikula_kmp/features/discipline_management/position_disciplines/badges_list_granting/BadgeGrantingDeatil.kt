...
import sikula_kmp.composeapp.generated.resources.to_grant
            ...
            for (record in records) {
                ...
                Surface(
                    ...
                    )
                    {
                        ...
                        Text(
                            text = campBadges.find { it.id == record.badgeId }?.name?.replace(
                        ...
                        PrimaryButton(
                            ...
                            content = {
                                Text(text = stringResource(Res.string.to_grant))
                            }
                        )
                    }
                }
