        ...
        Surface(
            ...
            )
            {
                ...
                Row(
                    ...
                    Text(
                        text = if (discipline == Discipline.Individual.TRAIL && record.value != null) formatTrailTime(
                            record.value.toInt()
                        ) else if (discipline == Discipline.Individual.AGILITY) {
                            "${getAgilityName(record.quest)}: ${record.value ?: stringResource(Res.string.empty_value)}"
                        } else {
                            record.value ?: stringResource(Res.string.empty_value)
                        },
